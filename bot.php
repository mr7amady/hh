      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/XXOOO0",
                   'caption'=>'تمت البرمجه بواسطه fᑌᖇY.𖤐',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب 🌚','callback_data'=>'login']],
                       [['text'=>"اضغط لمراسله المطور للابلاغ عن مشاكل 🇮🇶", 'url'=>"https://t.me/YYUYYY4"]],
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/YYUYYY4']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/XXOOO0"]],
                      ]
                  ])
              ]);   
				}
